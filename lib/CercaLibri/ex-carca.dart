                  ...
                  return ListTile(
                    leading: ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        child: (_books[index]['volumeInfo']['imageLinks']?['thumbnail'] !=
                            null)
                            ? Image.network(
                          _books[index]['volumeInfo']['imageLinks']['thumbnail'],
                          fit: BoxFit
                              .fill, // Per adattare l'immagine al contenitore
                        )
                            : Image.asset(
                    ...
                    subtitle: Text(
                        'Author: ${_books[index]['volumeInfo']['authors'][0]}'),
                    trailing: GestureDetector(
                      onTap: () {
                        Map<String, dynamic> libro = {
                          "titolo": _books[index]['volumeInfo']['title'] ?? 'N/A',
                          "autore": (_books[index]['volumeInfo']['authors'] !=
                              null &&
                              _books[index]['volumeInfo']['authors'] is List)
                              ? _books[index]['volumeInfo']['authors'].join(', ')
                              : 'N/A',
                          "numero_pagine": _books[index]['volumeInfo']['pageCount'] ??
                              0,
                          "copertina": null,
                          "descrizione": _books[index]['volumeInfo']['description'] ??
                              'N/A',
                          "data_pubblicazione": null,
                          "google_books_id": _books[index]['id'] ?? 'N/A',
                          "copertina_url": _books[index]['volumeInfo']['imageLinks'] !=
                              null
                              ? _books[index]['volumeInfo']['imageLinks']['thumbnail'] ??
                              ''
                              : '',
